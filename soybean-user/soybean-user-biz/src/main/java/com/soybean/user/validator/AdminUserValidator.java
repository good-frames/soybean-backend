 ...
 */
@Component
public class AdminUserValidator extends BaseUserValidator implements Validator {

    @Override
    public boolean supports(Class<?> clazz) {
        return AdminUserDTO.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        AdminUserDTO adminUser = (AdminUserDTO) target;
